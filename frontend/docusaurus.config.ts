...
const config: Config = {
  ...
  tagline: 'An exploration of modern robotics with Spec-Driven Development.',
  ...
  */
  ...
  presets: [
    [
      'classic',
      {
        ...
        blog: false, // Disabled the blog feature
        theme: {
  ...
  customFields: {
    apiBaseUrl: process.env.DOCUSAURUS_BACKEND_API_URL || 'http://localhost:8000',
  },
          ...
          items: [
            {
              ...
              to: '/docs/module-1-ros-foundations/week-1', // Link to the first week of content
            },
          ],
        },
        {
